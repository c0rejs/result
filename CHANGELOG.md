...
Compare with the previous release: [v6.5.26](https://github.com/c0rejs/result/compare/v6.5.26...v6.5.27)
...
- chore: remove npm @sencha:registry (● [6df9977](https://github.com/c0rejs/result/commit/6df9977); 👬 zdm)

Compare with the previous release: [v6.5.24](https://github.com/c0rejs/result/compare/v6.5.24...v6.5.25)
...
- build: migrate to c0rejs namespace (● [483e21d](https://github.com/c0rejs/result/commit/483e21d); 👬 zdm)

Compare with the previous release: [v6.5.22](https://github.com/c0rejs/result/compare/v6.5.22...v6.5.23)
